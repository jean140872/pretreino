    ...
    <main className="signup-page">
      ...
      <section className="signup-content">
        ...
        <div className="athlete-art" aria-hidden="true">
          <div className="athlete-photo-wrap athlete-male"><img className="athlete-photo" src="https://images.pexels.com/photos/8874919/pexels-photo-8874919.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="" loading="eager" referrerPolicy="no-referrer" /></div>
        ...
        <div className="signup-card">
          ...
          <div className="social-row"><button type="button" onClick={() => oauth('google')}><span className="social-logo google-logo">G</span><span>Google</span></button><button type="button" onClick={() => oauth('apple')}><span className="social-logo apple-logo">●</span><span>Apple</span></button></div>
      ...
      <style jsx global>{`
        ...
        .athlete-art{left:8px!important;bottom:0!important;width:min(61vw,800px)!important;height:92%!important;opacity:.5!important;z-index:3!important;overflow:hidden!important;mask-image:linear-gradient(to right,transparent 0%,black 7%,black 76%,transparent 100%)!important;-webkit-mask-image:linear-gradient(to right,transparent 0%,black 7%,black 76%,transparent 100%)!important}
        .athlete-photo-wrap{bottom:0!important;width:48%!important;height:90%!important;opacity:.72!important;overflow:hidden!important}.athlete-photo-wrap:after{content:""!important;position:absolute!important;inset:0!important;background:linear-gradient(to bottom,rgba(3,2,13,.08),rgba(3,2,13,.18) 48%,rgba(3,2,13,.94) 100%)!important;mix-blend-mode:multiply!important}.athlete-photo{width:100%!important;height:100%!important;object-fit:cover!important;object-position:center 20%!important;filter:saturate(.85) contrast(1.08)!important;mix-blend-mode:screen!important}
        .athlete-male{left:0!important;height:88%!important;clip-path:polygon(0 0,100% 0,90% 100%,0 100%)!important}.athlete-female{left:44%!important;height:94%!important;clip-path:polygon(13% 0,100% 0,100% 100%,0 100%)!important}
        .athlete-male .athlete-photo{object-position:center 18%!important}.athlete-female .athlete-photo{object-position:center 18%!important}
        ...
        .or{display:flex!important;align-items:center!important;gap:16px!important;margin:24px 0 18px!important;color:#e8e6ef!important;font-size:14px!important;font-weight:500!important;opacity:1!important}.or:before,.or:after{content:""!important;display:block!important;height:1px!important;flex:1!important;background:linear-gradient(90deg,transparent,#7d7f91 18%,#7d7f91 82%,transparent)!important;opacity:1!important}.or span{white-space:nowrap!important;text-shadow:0 1px 8px rgba(0,0,0,.8)!important}
        .social-row{gap:16px!important}.social-row button{height:52px!important;border:1px solid rgba(255,255,255,.32)!important;border-radius:11px!important;background:rgba(2,3,10,.96)!important;color:#fff!important;opacity:1!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:10px!important;font-size:15px!important;font-weight:700!important;box-shadow:inset 0 1px rgba(255,255,255,.08),0 10px 24px rgba(0,0,0,.28)!important}.social-row button:hover{border-color:#a06cff!important;background:#0b0c18!important;transform:translateY(-1px)!important}.social-logo{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:20px!important;height:20px!important;font-weight:800!important}.google-logo{font-size:17px!important}.apple-logo{font-size:12px!important;color:#fff!important}.consent{color:#aaa7b5!important}
        @media(max-width:1050px){.signup-content{grid-template-columns:1fr!important;max-width:760px!important}.athlete-art{width:100%!important;height:70%!important;opacity:.22!important}.signup-card{margin-top:10px!important}}
        @media(max-width:700px){.signup-content{width:calc(100% - 28px)!important;padding:30px 0!important}.signup-hero h1{font-size:43px!important}.benefit-grid{grid-template-columns:1fr!important}.athlete-art{height:62%!important;opacity:.16!important}.signup-card{padding:27px 20px!important}.signup-fields.two-cols{grid-template-columns:1fr!important}.social-row{grid-template-columns:1fr!important}}
      `}</style>
    </main>
  )
}
