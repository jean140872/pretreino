  ...
  return (
    <main className="signup-page">
      ...
      <section className="signup-content">
        ...
        <div className="signup-card">
          ...
          <form onSubmit={submit} className="signup-form">
            ...
            <button className="signup-submit" type="submit" disabled={submitting}>{submitting ? 'Criando sua conta...' : <>Criar minha conta <span>→</span></>}</button>
          </form>
      ...
      <style jsx global>{`
        ...
        .signup-form{gap:18px!important}.signup-form input:not([type=checkbox]){height:54px!important;background:rgba(3,5,18,.7)!important}.signup-submit{height:56px!important}.signup-submit:disabled{opacity:.7!important;cursor:wait!important}
